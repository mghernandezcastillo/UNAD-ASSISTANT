...
export const TabShareGuideModal: React.FC<TabShareGuideModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-100/80 dark:bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-[#020617]/90 backdrop-blur-2xl border border-black/10 dark:border-white/10 rounded-2xl max-w-lg w-full p-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-cyan-400/10 border border-cyan-400/20 flex items-center justify-center text-cyan-600 dark:text-cyan-400">
            <Tv size={22} />
          </div>
          <div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">Transmisión de Pestaña (Pantalla y Audio)</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">Transcripción en vivo + Consultas de visión en pantalla con bajo consumo</p>
          </div>
        </div>
        ...
        <div className="p-3 bg-gradient-to-r from-cyan-500/10 to-indigo-500/10 border border-cyan-400/20 rounded-xl mb-4 text-xs text-cyan-200 flex items-center gap-2.5">
          <Zap size={18} className="text-cyan-600 dark:text-cyan-400 shrink-0" />
        ...
        <div className="space-y-3.5 my-4">
          <div className="bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-xl p-3.5 flex gap-3 items-start backdrop-blur-md">
          ...
          <div className="bg-cyan-400/10 border border-cyan-400/30 rounded-xl p-3.5 flex gap-3 items-start relative overflow-hidden backdrop-blur-md">
            ...
            <div>
              <p className="text-sm font-bold text-cyan-700 dark:text-cyan-300 flex items-center gap-1.5">
              ...
              <p className="text-xs text-slate-700 dark:text-slate-200 mt-1 leading-relaxed">
                ...
                <span className="bg-cyan-400/20 text-cyan-700 dark:text-cyan-300 px-1.5 py-0.5 rounded font-mono font-semibold border border-cyan-400/30">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-900 dark:text-white rounded-xl hover:bg-black/10 dark:hover:bg-black/10 dark:bg-white/10 transition"
          >
            Cancelar
          </button>
          <button
